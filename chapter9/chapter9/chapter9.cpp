...
int main()
{
	...
	// Step 18
	cout << setw(25) << "dArr by [subscript]: ";
	for (int i = 0; i < 5; i++)
		cout << dArr[i] << ' ';
	cout << endl;

	// Step 19
	cout << setw(25) << "pdArray by *pointer: ";
	for (int i = 0; i < 5; i++)
		cout << *(pdArray + i) << ' ';
	cout << endl;

	// Step 20
	cout << setw(25) << "pdArray by *pointer v2: ";
	for (int i = 0; i < 5; i++)
		cout << *(pdArray++) << ' ';
	cout << endl;

	// Step 21
	cout << setw(25) << "dArr by *pointer: ";
	for (int i = 0; i < 5; i++)
		cout << *(dArr + i) << ' ';
	cout << endl;
